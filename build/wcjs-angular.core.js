...
angular.module('wcjs-angular').constant('WC_STATES', {
  ...
  tracks: [],
  poster: null
}).factory('playerConfig', function(defaultPlayerConfig) {
  return {
...
angular.module('wcjs-angular').controller('wcController', function($scope, $window, wcFullscreen, wcjsRenderer, WC_UTILS, WC_STATES, WC_VOLUME_KEY) {
...
angular.module('wcjs-angular').service('wcFullscreen', function(WC_UTILS, WC_FULLSCREEN_APIS) {
...
angular.module('wcjs-angular').service('WC_UTILS', function($window) {
...
}).directive('wcBottomControls', function($timeout, WC_STATES) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    transclude: true,
...
angular.module('wcjs-angular.plugins').directive('wcPlaybackButton', function(WC_UTILS, hotkeys) {
  return {
    restrict: 'E',
    require: '^chimerangular',
...
}).directive('wcScrubBar', function(WC_STATES, WC_UTILS) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    transclude: true,
...
}).service('wcNextVideoService', function($http, $q, $sce) {
  var deferred;
  deferred = $q.defer();
