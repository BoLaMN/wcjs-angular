...
}).factory('wcjsRenderer', ["Texture", "os", function(Texture, os) {
...
angular.module('wcjs-angular.plugins.analytics', ['angulartics']).directive('wcAnalytics', ["$analytics", "WC_STATES", function($analytics, WC_STATES) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    scope: {
...
angular.module('wcjs-angular.plugins.bottom-controls').directive('wcPlayPauseButton', ["WC_STATES", function(WC_STATES) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    scope: {},
...
angular.module('wcjs-angular.plugins.bottom-controls').directive('wcPlaybackButton', ["WC_UTILS", function(WC_UTILS) {
  return {
    restrict: 'E',
    require: '^chimerangular',
...
angular.module('wcjs-angular.plugins.bottom-controls').directive('wcVolumeBar', ["WC_UTILS", function(WC_UTILS) {
  return {
    restrict: 'E',
    require: '^chimerangular',
...
angular.module('wcjs-angular.plugins.bottom-controls').directive('wcVolume', ["WC_UTILS", function(WC_UTILS) {
  return {
    restrict: 'E',
    link: function(scope, elem, attr) {
...
angular.module('wcjs-angular.plugins.buffering', []).directive('wcBuffering', ["WC_STATES", "WC_UTILS", function(WC_STATES, WC_UTILS) {
  return {
    restrict: 'E',
    require: '^chimerangular',
...
angular.module('wcjs-angular.plugins.ima-ads', []).directive('wcImaAds', ["$window", "WC_STATES", function($window, WC_STATES) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    scope: {
...
angular.module('wcjs-angular.plugins.next-video', []).directive('wcNextVideo', ["$timeout", function($timeout) {
  return {
    restrict: 'E',
    require: '^chimerangular',
...
angular.module('wcjs-angular.plugins.overlay-play', []).directive('wcOverlayPlay', ["WC_STATES", function(WC_STATES) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    scope: {},
...
angular.module('wcjs-angular.plugins.top-controls', []).directive('wcTopControls', ["$timeout", "WC_STATES", function($timeout, WC_STATES) {
  return {
    restrict: 'E',
    require: '^chimerangular',
    transclude: true,
